...
fprintf('>>>>--train root filters of right-hand-view--<<<<\n')
try
...
% and hard negatives
fprintf('>>>>--train root filters of both view--<<<<\n')
try
    load([cachedir cls '_lrsplit2']);
catch
    initrand();
    for i = 1:n
        % make symmetric root filters for left-hand view
...
fprintf('>>>>--add parts and update models--<<<<\n')
try
