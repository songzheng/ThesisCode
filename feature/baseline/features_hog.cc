...
mxArray *process(const mxArray *mximage, const mxArray *mxsbin) {
  ...
  out[2] = 27+4;//corresponds to 31 of rootfilters.w
...
//       mexPrintf("\n");
  ...
  for (int x = 0; x < out[1]; x++) {
      for (int y = 0; y < out[0]; y++) {
          ...
          //sum over orientations of current block
          double t1 = 0;
          double t2 = 0;
          double t3 = 0;
          double t4 = 0;
          
          // contrast-sensitive features, 18 dimensions of each orientation
          ...
          // contrast-insensitive features, 9 dimension of each pair of verticalangles
          src = hist + (x+1)*blocks[0] + (y+1);
          for (int o = 0; o < 9; o++) {
          ...
          // texture features, 4 dimension of 4 adjacent blocks
          // 0.2357=1/sqrt(18), norm over 18 orientations
          *dst = 0.2357 * t1;
          dst += out[0]*out[1];
          *dst = 0.2357 * t2;
          dst += out[0]*out[1];
